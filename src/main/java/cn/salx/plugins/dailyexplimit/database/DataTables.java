...
public enum DataTables {
    ...
    private static DatabaseDriverType databaseDriverType;
    ...
    public static void initializeTables(@NotNull SQLManager sqlManager,
                                        ...
                                        DatabaseDriverType databaseDriverType) throws SQLException {
        DataTables.databaseDriverType = databaseDriverType;
